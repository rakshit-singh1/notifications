        ...
        for (const txHash of block.transactions) {
            ...
            if (receipt.contractAddress) {
                ...
                .create({
                    ...
                    from: '+12512573846', // Your Twilio phone number
                    to: '+917678491455'   // Recipient phone number
                })
                ...
                contract.on('Transfer', (from, to, value) => {
                    ...
                    client.messages
                        .create({
                            body: `ERC20 deployed at address:${contract}`,
                            from: '+12512573846', // Your Twilio phone number
                            to: '+918700676609'   // Recipient phone number
                        })
                        .then(message => console.log('Message sent successfully:', message.sid))
                        .catch(err => console.error('Error sending message:', err));
                });
                // contract.on('_mint', (account, value) => {
                //     console.log('--- ERC-20 Mint ---\n');
